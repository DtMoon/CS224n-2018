...
def getRegularizationValues():
    ...
    ### YOUR CODE HERE
    values = 10 ** np.random.uniform(-2, 2, 10)
    ### END YOUR CODE
...
def main(args):
    ...
    print("Best regularization value: {:.2e}".format(bestResult["reg"]))
    print("Test accuracy (%%): {:f}".format(bestResult["test"]))
